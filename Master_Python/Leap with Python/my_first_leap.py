...
class SampleListener(Leap.Listener):
    ...
    def on_init(self, controller):
        ...
        self.a = Arduino(serial_port='COM5')
        
        # sleep to ensure ample time for computer to make serial connection 
        time.sleep(3)
        
        # Define Pins for Arduino Servos
        self.PIN2 = 3 # Azimuthal 3
        self.PIN3 = 9 # Altitude  9
        self.PIN4 = 5 # Wrist     5
        self.PIN5 = 10 # Claw  6
        # self.previous_angles = [90,90,90,90]
    ...
    def on_exit(self, controller):
        ...
        self.a.servo_write(self.PIN3,10) # Alt
        self.a.servo_write(self.PIN4,90) # Wrist
        self.a.servo_write(self.PIN5,0) # Claw
        self.a.close()
    ...
    def on_frame(self, controller):
        ...
        if self.newtime-self.oldtime > 0.08: # every 10 ms get a frame //
        ...
        # Get the most recent frame and report some basic information
            ...
            for hand in frame.hands:
                ...
                if len(hand.fingers) >= 2:
                    ...
                    r = ( (x1-x2)**2 + (y1-y2)**2 + (z1-z2)**2 )**0.5  #can bac 2
