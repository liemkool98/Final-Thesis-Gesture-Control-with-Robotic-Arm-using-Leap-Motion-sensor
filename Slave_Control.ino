...
int SERVO2_PIN = 3; // azimuth angle
int SERVO3_PIN = 9; // altitude angle
int SERVO4_PIN = 5; // wrist angle
int SERVO5_PIN = 10; //claw angle
...
void setup() {
    ...
    SERVO2.write(90); // reset to original position
